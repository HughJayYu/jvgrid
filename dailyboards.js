...
(async () => {
    ...
    while (day <= maxDays) {
		...
		if (!(possibleAnswers[0].includes(0) || possibleAnswers[1].includes(0) || possibleAnswers[2].includes(0) || possibleAnswers[0].includes(1) || possibleAnswers[0].includes(2) || possibleAnswers[1].includes(1) || possibleAnswers[1].includes(2) || possibleAnswers[2].includes(2) || possibleAnswers[2].includes(2))) {
